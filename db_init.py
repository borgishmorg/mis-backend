...
with session_scope() as session:
    ...
    therapist_examinations_edit = Permission(code='examinations:therapist:edit', name='Редактирование терапевтических осмотров')
    therapist_examinations_view = Permission(code='examinations:therapist:view', name='Просмотр терапевтических осмотров')
